...
function PAGE_META(clientName){
  return {
    ...
    'fin-clientes': { title:'Clientes', sub:'Cadastro de clientes — dados cadastrais, serviço e valor mensal' },
    'fin-caixa': { title:'Caixa', sub:'Boletos e notas fiscais — controle de recebimentos por mês' },
